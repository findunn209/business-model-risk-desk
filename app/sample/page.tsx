...
export default function SampleAnatomyPage() {
  const { company, glance, kills } = sampleReport;
      ...
      <ol className="mt-14 space-y-10">
        ...
        <li>
          ...
          <p className="mt-3 max-w-xl leading-relaxed">
            ...
            marketplace with an in-app take-rate — before we say how that model
            dies. The object of the report is the model, not the worth of the
            people running it.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p className="mt-3 max-w-xl leading-relaxed">
            {kills.length} rows. The first two sit on this_cycle because
            bypass and unit economics are the same leak. Later rows (supply
            unwind, liability, demand capture) can finish the model if the leak
        ...
        <li>
          ...
          <p className="mt-3 max-w-xl leading-relaxed">
            ...
            bypassed. It is not a recommendation to keep or kill the company.
          </p>
        </li>
      </ol>
    </main>
