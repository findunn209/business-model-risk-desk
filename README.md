...
The sample uses **Porchlist**, a labeled-fake local-services marketplace. The worked glance is: you took the money and have not checked who the worker is, that they can do this job here, and that the work got done (inferred, contingent). Charging the homeowner is merchant of record because the operator takes 100% of the payment, then pays the worker. Further failure modes: a “verified” badge is not a first-job check, off-platform repeat work. The report also has PSP underwrite tripwires and a legal-and-contractable section.
